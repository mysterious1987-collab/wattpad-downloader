...
1) Vào tab **Actions** → workflow **Wattpad Downloader v2.5**
2) Bấm **Run workflow**
   ...
   - **file_basename_mode**: `api_title` (mặc định) hoặc `story_id` — tên file trong artifact
...
- `docs/PLAN.md`
- `docs/HISTORY.md`
- `docs/GITHUB-UPDATE.md` — copy gói v2.5 lên root repo GitHub và push
